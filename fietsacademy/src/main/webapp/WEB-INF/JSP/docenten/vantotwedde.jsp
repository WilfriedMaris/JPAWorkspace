...
<html lang="nl">
<head>
<vdab:head title="Docenten van tot wedde" />
<style>
...
<body>
	...
	<form>
		...
		<label>Tot:<span>${fouten.tot}</span><input name='tot'
			value="${empty tot ? param.tot : tot}" type="number" min='0' step='0.01' required>
		</label> <input type="submit" value="Zoeken">
	</form>
	<c:if test="${not empty param and empty fouten and empty docenten}">
	Geen docenten gevonden</c:if>
