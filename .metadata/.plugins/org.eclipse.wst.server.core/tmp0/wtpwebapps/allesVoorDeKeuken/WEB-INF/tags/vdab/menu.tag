<%@tag description = 'menu van pagina' pageEncoding='UTF-8'%>
<%@taglib prefix = 'c' uri = 'http://java.sun.com/jsp/jstl/core' %>
	<nav>
		<ul>
			...
			<li><a href = '<c:url value="/artikels/zoekenopnaam.htm"/>'>Artikel zoeken op naam</a></li>
			...
			<li><a href = '<c:url value="/artikels/perartikelgroep"/>'>Artikels per artikelgroep</a></li>
		</ul>
	</nav>
